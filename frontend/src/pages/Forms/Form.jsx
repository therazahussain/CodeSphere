...
import { setEditorCode, setIsAuth, setLanguage, setLoading, setOutput } from '../../store';
      ...
      <div className="formPageWrapper">
        ...
        <div className="formWrapper">
          ...
          <div className="inputGroup">
            ...
            <input type="text" className="inputBox" placeholder='ROOM ID' value={roomId} onChange={handleRoomId} onKeyUp={handleInputEnter} />

            <input type="text" className="inputBox" placeholder='USERNAME' value={username} onChange={handleUsername} onKeyUp={handleInputEnter} />

            <button className="btn joinBtn" onClick={joinRoom}>Join</button>

            <span className="createInfo">If you Don't have an invite then create &nbsp;
              <span className='createBtn' onClick={createNewRoom}>new room</span>
            </span>
